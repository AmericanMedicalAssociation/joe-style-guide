...
(function ($, Drupal) {
  Drupal.behaviors.vc_page = {
    attach: function (context, settings) {
      ...
      const inViewSection = document.querySelectorAll(':root[class*=vc-] article .c-paragraph');

      // Find the dimensions of inPageView
      const inPageView = function (e) {
        const distance = e.getBoundingClientRect();
        return (
          distance.top <= (window.innerHeight - 200 || document.documentElement.clientHeight - 200) &&
          distance.left >= 0 &&
